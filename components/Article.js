...
console.log(data[0]);
// let makeArticle =({ article })=>{
//   const articleElement = document.createElement('article');
//   articleElement.style.width = '20em';
...
// const test = articleMaker({title:'antoine', date:'june3, 1990', firstParagraph:'once upon a tib',secondParagraph:'we still here',
// thirdParagraph:'makin money'});
